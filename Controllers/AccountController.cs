            ...
            if(ModelState.IsValid)
            {
                ...
                if(user !=null)
                {
                    ...
                    else if(result.IsLockedOut)
                    {
                        ...
                        ModelState.AddModelError("",$"Hesabiniz kitlendi, Lutfen {timeLeft.Minutes} dakika sonra deneyiniz. ");
                    }
                    else
                    {
                ...
                {
                    ModelState.AddModelError("","Bu e mail adresiyle bir hesap bulunamadi.");
